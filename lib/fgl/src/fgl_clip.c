...
bool _fgl_triangle_winding (fgl_vertex_t inV[3]) {
...
int fgl_clip_triangle(fgl_vertex_t inV[3], fgl_vertex_t* outV) {
...
int fgl_clip_sprite(fgl_vertex_t inV[3], fgl_vertex_t* outV) {
	// Fast Off-screen clipping.
