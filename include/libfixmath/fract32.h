#ifndef libfixmath_fract32_h__
#define libfixmath_fract32_h__
...
#include <stdint.h>
    ...
    */
    extern fract32_t fract32_create(uint32_t inNumerator,
                                    uint32_t inDenominator);
    ...
    /** Performs unsigned saturated (overflow-protected) multiplication with the
     * two given fractions and returns the result as an unsigned integer.
     */
    extern uint32_t fract32_usmul(uint32_t inVal, fract32_t inFract);

    /** Performs saturated (overflow-protected) multiplication with the two
     * given fractions and returns the result as a signed integer.
     */
